(function () {
    ...
    body.insertAdjacentHTML("afterbegin", `
      <nav id="navbar" class="site-nav">
        ...
        <div class="nav-right">
          ...
          <button class="cart-trigger" type="button" data-cart-open aria-label="Open bag" aria-expanded="false" aria-controls="cartDrawer"><span>Bag</span><span class="cart-count-pill" id="cartCountNav">0</span></button>
        </div>
      </nav>
      <div class="mobile-menu" id="mobileMenu" role="navigation">${navLinks()}</div>
      ...
      <aside class="cart-drawer" id="cartDrawer" aria-label="Shopping bag">
        <div class="cart-header">
          ...
          <button class="cart-close-btn" type="button" data-cart-close aria-label="Close bag">Close</button>
        </div>
  ...
  function openCart() {
    ...
    doc.querySelectorAll("[data-cart-open]").forEach((el) => {
      ...
      el.setAttribute("aria-label", "Close bag");
    });
    renderCartContent();
  }
  ...
  function closeCart() {
    ...
    doc.querySelectorAll("[data-cart-open]").forEach((el) => {
      ...
      el.setAttribute("aria-label", "Open bag");
    });
  }
      ...
      <article class="product-card reveal">
        ...
        <div class="product-card-quick">
          <div class="quick-sizes">
            ${product.sizes.map((s) => `<button class="quick-size-btn" type="button" data-size="${s}" data-product="${product.id}" aria-label="Select size ${s}">${s}</button>`).join("")}

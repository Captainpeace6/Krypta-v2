(function () {
  ...
  function mountChrome() {
    body.insertAdjacentHTML("afterbegin", `
      <div class="nav-social-bar" id="navSocialBar">
        <span class="nsb-label">Follow Us</span>
        <div class="nsb-icons">
          ...
          <a class="nsb-icon" href="#" data-social="twitter" target="_blank" rel="noopener" aria-label="X (Twitter)">

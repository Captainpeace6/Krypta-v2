  ...
  function mountChrome() {
    body.insertAdjacentHTML("afterbegin", `
      ...
      <nav id="navbar" class="site-nav">
        <div class="nav-left">
          <button class="nav-toggle" type="button" data-menu-toggle aria-label="Open menu" aria-expanded="false"><span></span><span></span></button>
        ...
        <div class="nav-right">
          ...
          <button class="cart-trigger" type="button" data-cart-open aria-controls="cartDrawer" aria-expanded="false"><span>Bag</span><span class="cart-count-pill" id="cartCountNav">0</span></button>
        </div>
      </nav>
  ...
  function bindChromeEvents() {
    body.addEventListener("click", (event) => {
      ...
      if (menuToggle) {
        ...
        doc.querySelectorAll("[data-menu-toggle]").forEach(btn => {

    ...
    body.insertAdjacentHTML("afterbegin", `
      <nav id="navbar" class="site-nav">
        ...
        <div class="nav-right">
          ...
          <button class="cart-trigger" type="button" data-cart-open aria-label="Open shopping bag" aria-expanded="false" aria-controls="cartDrawer"><span>Bag</span><span class="cart-count-pill" id="cartCountNav">0</span></button>
        </div>
      </nav>
      ...
      <div class="cart-item">
        ...
        <div class="cart-item-info">
          ...
          <div class="cart-row">
            ...
            <button class="cart-line-remove" type="button" data-cart-remove="${item.key}" aria-label="Remove ${item.name} from bag">Remove</button>
          </div>
        </div>
      </div>
    `).join("");

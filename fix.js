...
G.textContent = `
  ...
  *,*::before,*::after{box-sizing:border-box}
  ...
  nav li.nav-cat > a, nav li.nav-cat { pointer-events:none!important }
  ...
  /* ── Add to cart buttons ── */
  [class*="add-to-cart"],button[class*="cart"],button[class*="add"]{
    font-family:'Bebas Neue',sans-serif!important;letter-spacing:.15em!important;
    background:transparent!important;border:1px solid rgba(200,255,0,.4)!important;
    color:#c8ff00!important;transition:background .2s,color .2s!important;cursor:pointer!important;
  }
...
// ═══════════════════════════════════════════════════
// § 2  NAV — CLEAN, SPACED, BIGGER LOGO
// ═══════════════════════════════════════════════════
...
NAV.textContent = `
  ...
  .nav-logo-img, nav a img, nav img.logo {
  ...
  .k-nav-dd-label{
    ...
    letter-spacing:.12em;color:rgba(240,237,232,.6);
    cursor:pointer;text-transform:uppercase;user-select:none;transition:color .2s;
    padding:4px 0;
  }
  ...
  .k-nav-dd-menu{
    ...
    min-width:190px;padding:6px 0;z-index:700;
  }
  ...
  @media(max-width:900px){
    .k-nav-center{display:none!important}
    body{padding-top:66px!important}
  }

  /* Mobile menu */
  #mobileMenu{
    display:none;position:fixed!important;top:66px;left:0;right:0;
  ...
  #mobileMenu a{
    ...
    border-bottom:1px solid #1a1a22!important;transition:color .2s,background .2s!important;
  }
  #mobileMenu a:hover{color:#e8d080!important;background:#0a0a0d!important}
`;
document.head.appendChild(NAV);

// Inject clean center nav (no JEANS)
...
// ═══════════════════════════════════════════════════
// § 3  LOGO REPLACEMENTS (nav + footer)
// ═══════════════════════════════════════════════════
(function(){
  ...
  if(fi){fi.src='imgs/kryptaa-logo-gold.png';fi.alt='KRYPTAA';fi.style.cssText='height:52px;width:auto;object-fit:contain;display:block;margin:0 auto;';}
})();

// ═══════════════════════════════════════════════════
// § 4  HERO — Cinematic, tight to next section
// ═══════════════════════════════════════════════════
...
HS.textContent = `
  ...
  .hero-glow{
    ...
    background:radial-gradient(ellipse at center,rgba(200,168,75,.65) 0%,rgba(120,80,15,.3) 40%,transparent 70%);
    animation:k-glow-pulse 5s ease-in-out infinite;z-index:2;pointer-events:none;
  }
  ...
  .hero-cta{
    ...
    font-size:clamp(14px,2.5vw,17px);letter-spacing:.22em;
    color:#000;background:#c8ff00;border:none;
    padding:15px 58px;cursor:pointer;text-decoration:none;text-transform:uppercase;
...
var heroHTML='<div id="kryptaa-hero-v2">'+
...
var heroSels=['.hero-section','#hero','.hero','[class*="hero"]','section.banner','.banner-section','#banner','main > section:first-child','main > div:first-child'];
var oldHero=null;
...
// ═══════════════════════════════════════════════════
// § 5  VIDEO SECTION — Cinematic campaign film
// ═══════════════════════════════════════════════════
var VS=document.createElement('style');
VS.textContent=`
  #k-video-section{
    position:relative;width:100%;height:65vh;min-height:360px;
  ...
  .v-bg{
    ...
    background:
      radial-gradient(ellipse at 20% 60%,rgba(45,25,5,.9) 0%,transparent 55%),
      radial-gradient(ellipse at 80% 40%,rgba(20,8,0,.85) 0%,transparent 55%),
      radial-gradient(ellipse at 50% 50%,rgba(30,15,3,.7) 0%,transparent 60%),
      linear-gradient(180deg,#000 0%,#060300 40%,#000 100%);
  }
  ...
  .v-grain{
    ...
    background-image:url("data:image/svg+xml,%3Csvg viewBox='0 0 180 180' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='g'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.88' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23g)' opacity='0.035'/%3E%3C/svg%3E");
  ...
  .v-scan-line{
    ...
    background:linear-gradient(90deg,transparent 0%,rgba(200,168,75,.15) 30%,rgba(200,168,75,.25) 50%,rgba(200,168,75,.15) 70%,transparent 100%);
  ...
  .v-title{
    ...
    font-size:clamp(54px,12vw,128px);letter-spacing:.04em;
...
var videoHTML='<section id="k-video-section">'+
  '<div class="v-bg"></div>'+
  '<div class="v-smoke-1"></div><div class="v-smoke-2"></div><div class="v-smoke-3"></div>'+
  '<div class="v-grain"></div>'+
  '<!-- Add video: <video autoplay muted loop playsinline src="your-film.mp4"></video> -->'+
...
// ═══════════════════════════════════════════════════
// § 6  CATEGORY GRID — 4 cards only (no JEANS/ANIME)
// ═══════════════════════════════════════════════════
...
CP.textContent=`
  ...
  /* MEN — tall left spanning 2 rows */
  .k-cc:nth-child(1){grid-row:1/3;min-height:580px}
  /* WOMEN — top right */
  .k-cc:nth-child(2){min-height:284px}
  /* T-SHIRTS — middle right */
  .k-cc:nth-child(3){min-height:284px}
  /* TRACK PANTS — full width bottom */
  .k-cc:nth-child(4){grid-column:1/3;min-height:200px}

  @media(max-width:768px){
    .k-cat-grid{grid-template-columns:1fr 1fr;grid-template-rows:auto}
    .k-cc:nth-child(1){grid-row:auto;grid-column:span 2;min-height:240px}
    .k-cc:nth-child(2){grid-column:span 1;min-height:200px}
    .k-cc:nth-child(3){grid-column:span 1;min-height:200px}
    .k-cc:nth-child(4){grid-column:span 2;min-height:180px}
  }
  @media(max-width:480px){
    .k-cat-grid{grid-template-columns:1fr}
    .k-cc:nth-child(n){grid-column:span 1!important;min-height:200px!important}
  }
  ...
  .k-cc .cc-ov{
    position:absolute;inset:0;
    background:linear-gradient(to top,rgba(0,0,0,.9) 0%,rgba(0,0,0,.05) 65%);
  }
  /* Gold bottom accent line */
  .k-cc .cc-line{
    position:absolute;bottom:0;left:0;right:0;height:2px;
    background:linear-gradient(90deg,transparent,rgba(200,168,75,.7),transparent);
  ...
  .cc-body .cc-cta{
    ...
    color:rgba(240,237,232,.35);text-transform:uppercase;
...
var catHTML='<section id="k-categories">'+
  ...
  '<a class="k-cc" href="men.html"><div class="cc-bg" style="background-image:url(\'imgs/jeans-gold-dragon.jpg\')"></div><div class="cc-ov"></div><div class="cc-line"></div><div class="cc-body"><div class="cc-lbl">Collection</div><h3>Men</h3><div class="cc-cta">Shop Now</div></div></a>'+
  '<a class="k-cc" href="women.html"><div class="cc-bg" style="background-image:url(\'imgs/w-vintage-dragon.jpg\')"></div><div class="cc-ov"></div><div class="cc-line"></div><div class="cc-body"><div class="cc-lbl">Collection</div><h3>Women</h3><div class="cc-cta">Shop Now</div></div></a>'+
  '<a class="k-cc" href="t-shirts.html"><div class="cc-bg" style="background-image:url(\'imgs/img-glorious.png\')"></div><div class="cc-ov"></div><div class="cc-line"></div><div class="cc-body"><div class="cc-lbl">Category</div><h3>T-Shirts</h3><div class="cc-cta">Shop Now</div></div></a>'+
  '<a class="k-cc" href="track-pants.html"><div class="cc-bg" style="background-image:url(\'imgs/jeans-grey-cargo.jpg\')"></div><div class="cc-ov"></div><div class="cc-line"></div><div class="cc-body"><div class="cc-lbl">Coming Drop 002</div><h3>Track Pants</h3><div class="cc-cta">Preview</div></div></a>'+
  '</div></section>';

// ═══════════════════════════════════════════════════
// § 7  FEATURED PIECES — Selected editorial highlights
// ═══════════════════════════════════════════════════
...
FP.textContent=`
  ...
  .k-fp-grid{
    ...
    gap:16px;max-width:1260px;margin:0 auto 48px;
  }
  @media(max-width:900px){.k-fp-grid{grid-template-columns:repeat(2,1fr)}}
  @media(max-width:480px){.k-fp-grid{grid-template-columns:repeat(2,1fr);gap:10px}}
  .k-fp-card{
  ...
  .k-fp-btn{
    ...
    font-size:12px;letter-spacing:.2em;padding:9px;
  ...
  .fp-view-all{
    ...
    border:1px solid rgba(240,237,232,.15);padding:12px 40px;
...
var featuredHTML='<section id="k-featured">'+
  '<div class="fp-header"><div class="k-eyebrow">Selected Pieces</div><h2>DROP 001</h2><p>Curated from the collection</p></div>'+
  '<div class="k-fp-grid">'+
  '<a class="k-fp-card" href="men.html"><div class="k-fp-img"><div class="k-fp-tag">SIGNATURE</div><img src="imgs/jeans-dual-dragon.jpg" alt="Dual Dragon Denim" loading="lazy"></div><div class="k-fp-info"><div class="k-fp-name">Dual Dragon Denim</div><div class="k-fp-price">$98</div><div class="k-fp-btn">Shop Now</div></div></a>'+
  '<a class="k-fp-card" href="men.html"><div class="k-fp-img"><div class="k-fp-tag">DROP 001</div><img src="imgs/jeans-gold-dragon.jpg" alt="Gold Dragon Denim" loading="lazy"></div><div class="k-fp-info"><div class="k-fp-name">Gold Dragon Denim</div><div class="k-fp-price">$75</div><div class="k-fp-btn">Shop Now</div></div></a>'+
  '<a class="k-fp-card" href="women.html"><div class="k-fp-img"><div class="k-fp-tag">FEATURED</div><img src="imgs/w-vintage-dragon.jpg" alt="Vintage Dragon" loading="lazy"></div><div class="k-fp-info"><div class="k-fp-name">Vintage Dragon</div><div class="k-fp-price">$70</div><div class="k-fp-btn">Shop Now</div></div></a>'+
  '<a class="k-fp-card" href="t-shirts.html"><div class="k-fp-img"><div class="k-fp-tag">NEW</div><img src="imgs/img-glorious.png" alt="Glorious Tee" loading="lazy"></div><div class="k-fp-info"><div class="k-fp-name">Glorious Tee</div><div class="k-fp-price">$35</div><div class="k-fp-btn">Shop Now</div></div></a>'+
  '</div>'+
...
BM.textContent=`
  ...
  #k-brand-story .bs-cta{
    display:inline-block;margin-top:8px;
    font-family:'Space Mono',monospace;font-size:8px;letter-spacing:.35em;
    color:rgba(200,168,75,.55);text-transform:uppercase;text-decoration:none;
    border-bottom:1px solid rgba(200,168,75,.2);padding-bottom:4px;
    transition:color .2s,border-color .2s;
  }
...
// § 9  SIZE GUIDE
// ═══════════════════════════════════════════════════
var sgHTML='<section id="k-size-guide" style="background:#060608;padding:80px 48px;text-align:center">'+
  '<div class="k-eyebrow">Sizing</div>'+
  '<h2 style="font-family:\'Bebas Neue\',sans-serif;font-size:clamp(28px,5vw,52px);letter-spacing:.1em;color:#fff;margin-bottom:8px">SIZE GUIDE</h2>'+
  '<p style="font-family:\'Space Mono\',monospace;font-size:8px;letter-spacing:.25em;color:#555560;text-transform:uppercase;margin-bottom:40px">Measure twice. Order once.</p>'+
  '<table style="width:100%;max-width:680px;margin:0 auto;border-collapse:collapse">'+
  '<thead><tr>'+
  '<th style="font-family:\'Bebas Neue\',sans-serif;font-size:14px;letter-spacing:.1em;color:#e8d080;padding:12px 16px;border-bottom:1px solid #1e1e26;text-align:center">SIZE</th>'+
  '<th style="font-family:\'Bebas Neue\',sans-serif;font-size:14px;letter-spacing:.1em;color:#e8d080;padding:12px 16px;border-bottom:1px solid #1e1e26;text-align:center">WAIST</th>'+
  '<th style="font-family:\'Bebas Neue\',sans-serif;font-size:14px;letter-spacing:.1em;color:#e8d080;padding:12px 16px;border-bottom:1px solid #1e1e26;text-align:center">HIP</th>'+
  '<th style="font-family:\'Bebas Neue\',sans-serif;font-size:14px;letter-spacing:.1em;color:#e8d080;padding:12px 16px;border-bottom:1px solid #1e1e26;text-align:center">INSEAM</th>'+
  '</tr></thead>'+
  '<tbody>'+
  ['28\",28",36",30"','30\",30",38",30"','32\",32",40",31"','34\",34",42",31"','36\",36",44",32"'].map(function(r){var p=r.split(',');return '<tr><td style="font-family:\'Space Mono\',monospace;font-size:9px;color:#555560;padding:10px 16px;border-bottom:1px solid #111116;text-align:center">'+p[0]+'</td><td style="font-family:\'Space Mono\',monospace;font-size:9px;color:#555560;padding:10px 16px;border-bottom:1px solid #111116;text-align:center">'+p[1]+'</td><td style="font-family:\'Space Mono\',monospace;font-size:9px;color:#555560;padding:10px 16px;border-bottom:1px solid #111116;text-align:center">'+p[2]+'</td><td style="font-family:\'Space Mono\',monospace;font-size:9px;color:#555560;padding:10px 16px;border-bottom:1px solid #111116;text-align:center">'+p[3]+'</td></tr>';}).join('')+
  '</tbody></table>'+
  '</section>';
...
// ═══════════════════════════════════════════════════
// § 10  HIDE OLD INDEX.HTML SECTIONS
// ═══════════════════════════════════════════════════
setTimeout(function(){
  var toHide=['.how-section','.story-section','.archive-section','.newsletter','#newsletter'];
  toHide.forEach(function(sel){
    document.querySelectorAll(sel).forEach(function(el){el.style.display='none';});
  });
  // Also hide any section that has the old nav-cat still showing
  var navCat=document.querySelector('.nav-cat');
  if(navCat) navCat.style.display='none';
},50);

// ═══════════════════════════════════════════════════
// § 11  PRODUCT GRID STYLING
// ═══════════════════════════════════════════════════
var GR=document.createElement('style');
GR.textContent=`
  .section,[class*="products"],[class*="product-sec"]{background:#060608!important;padding:60px 32px!important}
  .section h2{font-family:'Bebas Neue',sans-serif!important;font-size:clamp(26px,5vw,50px)!important;letter-spacing:.12em!important;color:#fff!important;margin-bottom:32px!important}
  [class*="grid"],[class*="slider"]{gap:18px!important}
`;
document.head.appendChild(GR);

// ═══════════════════════════════════════════════════
// § 12  MOBILE MENU (no JEANS)
// ═══════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════
// § 14  EXISTING FIXES (prices, track pants, checkout)
// ═══════════════════════════════════════════════════

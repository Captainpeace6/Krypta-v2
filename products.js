const RAW_PRODUCTS = [
  ...
  { id: 500, name: "Streetwear Wide-Leg Trouser — Blue", price: 42, sizes: ["XS", "S", "M", "L", "XL"], img: "imgs/pants/womens-st-blue-01.jpg", sizeChart: "imgs/pants/womens-st-sizechart.png", gallery: [{src:"imgs/pants/womens-st-blue-01.jpg",label:"Front"},{src:"imgs/pants/womens-st-blue-02.jpg",label:"Back"},{src:"imgs/pants/womens-st-blue-03.jpg",label:"Left Side"},{src:"imgs/pants/womens-st-blue-04.jpg",label:"Right Side"},{src:"imgs/pants/womens-st-blue-05.jpg",label:"45° Angle"},{src:"imgs/pants/womens-st-blue-06.jpg",label:"Detail"},{src:"imgs/pants/womens-st-blue-07.jpg",label:"Full Length"},{src:"imgs/pants/womens-st-sizechart.png",label:"Size Chart"}], category: "women_st", collection: "Women's Streetwear Trousers / Drop 001", tags: ["Wide Leg", "Blue", "Streetwear"], availability: "Limited Drop", desc: "Bold wide-leg street trouser in deep blue. Clean structured silhouette with a relaxed fit built for presence and movement." },
  { id: 501, name: "Streetwear Wide-Leg Trouser — Green", price: 42, sizes: ["XS", "S", "M", "L", "XL"], img: "imgs/pants/womens-st-green-01.jpg", sizeChart: "imgs/pants/womens-st-sizechart.png", gallery: [{src:"imgs/pants/womens-st-green-01.jpg",label:"Front"},{src:"imgs/pants/womens-st-green-02.jpg",label:"Back"},{src:"imgs/pants/womens-st-green-03.jpg",label:"Left Side"},{src:"imgs/pants/womens-st-green-04.jpg",label:"Right Side"},{src:"imgs/pants/womens-st-green-05.jpg",label:"45° Angle"},{src:"imgs/pants/womens-st-green-06.jpg",label:"Detail"},{src:"imgs/pants/womens-st-green-07.jpg",label:"Full Length"},{src:"imgs/pants/womens-st-sizechart.png",label:"Size Chart"}], category: "women_st", collection: "Women's Streetwear Trousers / Drop 001", tags: ["Wide Leg", "Green", "Streetwear"], availability: "Limited Drop", desc: "Wide-leg street trouser in muted green. Oversized drape with the same sharp KRYPTAA cut — built for the underground." },
  { id: 502, name: "Streetwear Wide-Leg Trouser — Red", price: 42, sizes: ["XS", "S", "M", "L", "XL"], img: "imgs/pants/womens-st-red-01.jpg", sizeChart: "imgs/pants/womens-st-sizechart.png", gallery: [{src:"imgs/pants/womens-st-red-01.jpg",label:"Front"},{src:"imgs/pants/womens-st-red-02.jpg",label:"Back"},{src:"imgs/pants/womens-st-red-03.jpg",label:"Left Side"},{src:"imgs/pants/womens-st-red-04.jpg",label:"Right Side"},{src:"imgs/pants/womens-st-red-05.jpg",label:"45° Angle"},{src:"imgs/pants/womens-st-red-06.jpg",label:"Detail"},{src:"imgs/pants/womens-st-sizechart.png",label:"Size Chart"}], category: "women_st", collection: "Women's Streetwear Trousers / Drop 001", tags: ["Wide Leg", "Red", "Streetwear"], availability: "Limited Drop", desc: "Statement red wide-leg trouser. High-impact colour meets a clean architectural cut — the loudest piece in the Drop 001 women's range." },
  { id: 503, name: "Streetwear Wide-Leg Trouser — Yellow", price: 42, sizes: ["XS", "S", "M", "L", "XL"], img: "imgs/pants/womens-st-yellow-01.jpg", sizeChart: "imgs/pants/womens-st-sizechart.png", gallery: [{src:"imgs/pants/womens-st-yellow-01.jpg",label:"Front"},{src:"imgs/pants/womens-st-yellow-02.jpg",label:"Back"},{src:"imgs/pants/womens-st-yellow-03.jpg",label:"Left Side"},{src:"imgs/pants/womens-st-yellow-04.jpg",label:"Right Side"},{src:"imgs/pants/womens-st-yellow-05.jpg",label:"45° Angle"},{src:"imgs/pants/womens-st-yellow-06.jpg",label:"Detail"},{src:"imgs/pants/womens-st-sizechart.png",label:"Size Chart"}], category: "women_st", collection: "Women's Streetwear Trousers / Drop 001", tags: ["Wide Leg", "Yellow", "Streetwear"], availability: "Limited Drop", desc: "Gold-yellow wide-leg trouser with a relaxed street silhouette. Pairs with black and earth tones for a clean drop-001 finish." }
];
...
const CATEGORY_CONFIGS = {
  ...
  women_st: {
    title: "Women's Streetwear Trousers",
    label: "Drop 001 Bottoms",
    nav: "Street Trousers",
    href: "women-streetwear-trousers.html",
    description: "Wide-leg street trousers in four bold colours — blue, green, red, and yellow. Clean architecture, underground attitude.",

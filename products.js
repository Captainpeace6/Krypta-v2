const RAW_PRODUCTS = [
  { id: 1, name: "Glorious Death Heavyweight Tee", price: 58, sizes: ["S", "M", "L", "XL"], img: "imgs/img-glorious.png", category: "tees", collection: "Heavyweight / Drop 001", tags: ["300GSM", "DTF Print", "Boxy"], availability: "Limited pre-order", desc: "A cornerstone of the KRYPTAA aesthetic: skeleton angel artwork, dense cotton structure, and a heavy box silhouette made to hold shape under black light." },
  { id: 2, name: "Cyber Crime Statement Tee", price: 58, sizes: ["S", "M", "L", "XL"], img: "imgs/img-crime.png", category: "tees", collection: "Heavyweight / Drop 001", tags: ["300GSM", "Gothic Type", "Oversized"], availability: "In production", desc: "Cyber-goth brush texture and bold front/back placement on an oversized black cotton base." },
  { id: 3, name: "Gothic Angel Oversized Tee", price: 58, sizes: ["S", "M", "L", "XL"], img: "imgs/img-angel.png", category: "tees", collection: "Heavyweight / Drop 001", tags: ["Angel Graphic", "Jet Black", "Heavyweight"], availability: "Limited pre-order", desc: "Intricate gothic line work placed on structured cotton for a sharp, draped streetwear silhouette." },
  { id: 4, name: "Broken Mirror Surrealist Tee", price: 58, sizes: ["S", "M", "L", "XL"], img: "imgs/img-broken.png", category: "tees", collection: "Heavyweight / Drop 001", tags: ["Surreal", "Premium Print", "Box Fit"], availability: "Low quantity", desc: "A fractured identity graphic rendered with a dark surrealist finish and a dense premium hand feel." },
  { id: 5, name: "Money Moves Typo Tee", price: 58, sizes: ["S", "M", "L", "XL"], img: "imgs/img-money.png", category: "tees", collection: "Heavyweight / Drop 001", tags: ["Type Graphic", "Street", "Box Fit"], availability: "In production", desc: "A direct typographic strike built for quiet confidence and hard silhouettes." },

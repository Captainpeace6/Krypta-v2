const RAW_PRODUCTS = [
  ...
  { id: 30, name: "Gothic Skull Wide-Leg", price: 51, sizes: ["XS", "S", "M", "L"], img: "imgs/pants/womens-pant-5.jpg", sizeChart: "imgs/pants/sizechart-pant-5.png", gallery: [{src:"imgs/pants/womens-pant-5.jpg",label:"Front"},{src:"imgs/pants/womens-pant-5-g2.jpg",label:"Back"},{src:"imgs/pants/womens-pant-5-g3.jpg",label:"Left Side"},{src:"imgs/pants/womens-pant-5-g4.jpg",label:"Right Side"},{src:"imgs/pants/womens-pant-5-g5.jpg",label:"45° Angle"},{src:"imgs/pants/womens-pant-5-g6.jpg",label:"Close Up"},{src:"imgs/pants/womens-pant-5-g7.jpg",label:"Detail"},{src:"imgs/pants/womens-pant-5-g8.jpg",label:"Detail 2"},{src:"imgs/pants/womens-pant-5-g9.jpg",label:"Detail 3"},{src:"imgs/pants/womens-pant-5-g10.jpg",label:"Detail 4"},{src:"imgs/pants/sizechart-pant-5.png",label:"Size Chart"}], category: "women", collection: "Women's Denim / Drop 001", tags: ["Pink Skull", "Wide Leg", "Gothic Art"], availability: "Limited Drop", desc: "Black wide-leg denim with full pink gothic skull and angelic script print across the back. High-waist silhouette with a dramatic floor-length stack." },
  { id: 31, name: "Gold Baroque Wide-Leg", price: 62, sizes: ["XS", "S", "M", "L"], img: "imgs/pants/womens-pant-6-g5.jpg", sizeChart: "imgs/pants/sizechart-pant-6.png", gallery: [{src:"imgs/pants/womens-pant-6.jpg",label:"Front"},{src:"imgs/pants/womens-pant-6-g2.jpg",label:"Back"},{src:"imgs/pants/womens-pant-6-g3.jpg",label:"Left Side"},{src:"imgs/pants/womens-pant-6-g4.jpg",label:"Right Side"},{src:"imgs/pants/womens-pant-6-g5.jpg",label:"45° Angle"},{src:"imgs/pants/womens-pant-6-g6.jpg",label:"Close Up"},{src:"imgs/pants/womens-pant-6-g7.jpg",label:"Detail"},{src:"imgs/pants/womens-pant-6-g8.jpg",label:"Detail 2"},{src:"imgs/pants/womens-pant-6-g9.jpg",label:"Detail 3"},{src:"imgs/pants/womens-pant-6-g10.jpg",label:"Detail 4"},{src:"imgs/pants/sizechart-pant-6.png",label:"Size Chart"}], category: "women", collection: "Women's Denim / Drop 001", tags: ["Gold Baroque", "Wide Leg", "Ornamental"], availability: "Limited Drop", desc: "Black wide-leg denim with full gold baroque ornamental print. Opulent gothic energy from waist to hem." },
  { id: 32, name: "Creature Graphic Wide-Leg", price: 62, sizes: ["XS", "S", "M", "L", "XL"], img: "imgs/pants/unisex-pant-7.jpg", sizeChart: "imgs/pants/sizechart-pant-7.png", gallery: [{src:"imgs/pants/unisex-pant-7.jpg",label:"Front"},{src:"imgs/pants/unisex-pant-7-g2.jpg",label:"Back"},{src:"imgs/pants/unisex-pant-7-g3.jpg",label:"Left Side"},{src:"imgs/pants/unisex-pant-7-g4.jpg",label:"Right Side"},{src:"imgs/pants/unisex-pant-7-g5.jpg",label:"45° Angle"},{src:"imgs/pants/unisex-pant-7-g6.jpg",label:"Close Up"},{src:"imgs/pants/unisex-pant-7-g7.jpg",label:"Detail"},{src:"imgs/pants/unisex-pant-7-g8.jpg",label:"Detail 2"},{src:"imgs/pants/sizechart-pant-7.png",label:"Size Chart"}], category: "women", collection: "Women's Denim / Drop 001", tags: ["Creature Print", "Wide Leg", "Unisex"], availability: "Limited Drop", desc: "Black wide-leg denim with scattered white creature graphic across both legs. Unisex cut with a bold underground statement." },

  { id: 50, name: "Silver Mesh Crop Top", price: 16.50, sizes: ["XS", "S", "M", "L"], img: "imgs/tops/top-50.jpeg", category: "tops", collection: "Women's Festival / Drop 001", tags: ["Silver Mesh", "Chain Strap", "Festival"], availability: "In stock", desc: "Shimmering silver mesh crop top with chain strap. Festival statement piece built for after-dark presence." },
  { id: 51, name: "Silver Mesh Mini Skirt", price: 16.50, sizes: ["XS", "S", "M", "L"], img: "imgs/tops/top-51.jpeg", category: "tops", collection: "Women's Festival / Drop 001", tags: ["Silver Mesh", "Chain Waist", "Mini"], availability: "In stock", desc: "Silver mesh mini skirt with chain waistband. Draped silhouette for movement and impact." },
  { id: 52, name: "Silver Mesh Set", price: 30, sizes: ["XS", "S", "M", "L"], img: "imgs/tops/top-52.jpeg", category: "tops", collection: "Women's Festival / Drop 001", tags: ["Mesh Set", "Crop + Skirt", "Limited"], availability: "Limited Drop", desc: "Full silver mesh set — crop top and mini skirt together. The complete festival drop." },
  { id: 60, name: "Aurora Halter Top", price: 19, sizes: ["XS", "S", "M", "L"], img: "imgs/tops/top-60.jpeg", category: "tops", collection: "Women's Festival / Drop 001", tags: ["Iridescent", "Chainmail", "Halter"], availability: "In stock", desc: "Iridescent rainbow chainmail halter with open-front and rhinestone clasp. Catches every light." },
  { id: 61, name: "Gold Diamond Chain Bra", price: 8.99, sizes: ["XS", "S", "M", "L"], img: "imgs/tops/top-61.jpeg", category: "tops", collection: "Women's Festival / Drop 001", tags: ["Gold", "Rhinestone", "Chain"], availability: "In stock", desc: "Gold rhinestone triangle chain bra with mesh choker. Body jewellery as fashion." },
  { id: 62, name: "Crystal Heart Chain Top", price: 12.99, sizes: ["XS", "S", "M", "L"], img: "imgs/tops/top-62.jpeg", category: "tops", collection: "Women's Festival / Drop 001", tags: ["Crystal", "Chain Detail", "Festival"], availability: "In stock", desc: "Silver crystal mesh cups with draped chain detail. Sparkles under any light." },
  ...
  { id: 500, name: "Unisex Street Track Pant — Blue", price: 42, sizes: ["XS", "S", "M", "L", "XL"], soldOutSizes: [], img: "imgs/pants/womens-st-blue-01.jpg", sizeChart: "imgs/pants/womens-st-sizechart.png", gallery: [{src:"imgs/pants/womens-st-blue-01.jpg",label:"Front"},{src:"imgs/pants/womens-st-blue-02.jpg",label:"Back"},{src:"imgs/pants/womens-st-blue-03.jpg",label:"Left Side"},{src:"imgs/pants/womens-st-blue-04.jpg",label:"Right Side"},{src:"imgs/pants/womens-st-blue-05.jpg",label:"45° Angle"},{src:"imgs/pants/womens-st-blue-06.jpg",label:"Detail"},{src:"imgs/pants/womens-st-blue-07.jpg",label:"Full Length"},{src:"imgs/pants/womens-st-sizechart.png",label:"Size Chart"}], category: "women_st", collection: "Unisex Street Track Pants / Drop 001", tags: ["Track Pant", "Blue", "Unisex"], availability: "Limited Drop", desc: "Bold wide-leg track pant in deep blue. Clean structured silhouette with a relaxed fit built for presence and movement." },
  { id: 501, name: "Unisex Street Track Pant — Green", price: 42, sizes: ["XS", "S", "M", "L", "XL"], soldOutSizes: [], img: "imgs/pants/womens-st-green-01.jpg", sizeChart: "imgs/pants/womens-st-sizechart.png", gallery: [{src:"imgs/pants/womens-st-green-01.jpg",label:"Front"},{src:"imgs/pants/womens-st-green-02.jpg",label:"Back"},{src:"imgs/pants/womens-st-green-03.jpg",label:"Left Side"},{src:"imgs/pants/womens-st-green-04.jpg",label:"Right Side"},{src:"imgs/pants/womens-st-green-05.jpg",label:"45° Angle"},{src:"imgs/pants/womens-st-green-06.jpg",label:"Detail"},{src:"imgs/pants/womens-st-green-07.jpg",label:"Full Length"},{src:"imgs/pants/womens-st-sizechart.png",label:"Size Chart"}], category: "women_st", collection: "Unisex Street Track Pants / Drop 001", tags: ["Track Pant", "Green", "Unisex"], availability: "Limited Drop", desc: "Wide-leg track pant in muted green. Oversized drape with the same sharp KRYPTAA cut — built for the underground." },
  { id: 502, name: "Unisex Street Track Pant — Red", price: 42, sizes: ["XS", "S", "M", "L", "XL"], soldOutSizes: ["XS"], img: "imgs/pants/womens-st-red-01.jpg", sizeChart: "imgs/pants/womens-st-sizechart.png", gallery: [{src:"imgs/pants/womens-st-red-01.jpg",label:"Front"},{src:"imgs/pants/womens-st-red-02.jpg",label:"Back"},{src:"imgs/pants/womens-st-red-03.jpg",label:"Left Side"},{src:"imgs/pants/womens-st-red-04.jpg",label:"Right Side"},{src:"imgs/pants/womens-st-red-05.jpg",label:"45° Angle"},{src:"imgs/pants/womens-st-red-06.jpg",label:"Detail"},{src:"imgs/pants/womens-st-sizechart.png",label:"Size Chart"}], category: "women_st", collection: "Unisex Street Track Pants / Drop 001", tags: ["Track Pant", "Red", "Unisex"], availability: "Limited Drop", desc: "Statement red wide-leg track pant. High-impact colour meets a clean architectural cut — the standout piece in Drop 001." },
  { id: 503, name: "Unisex Street Track Pant — Yellow", price: 42, sizes: ["XS", "S", "M", "L", "XL"], soldOutSizes: [], img: "imgs/pants/womens-st-yellow-01.jpg", sizeChart: "imgs/pants/womens-st-sizechart.png", gallery: [{src:"imgs/pants/womens-st-yellow-01.jpg",label:"Front"},{src:"imgs/pants/womens-st-yellow-02.jpg",label:"Back"},{src:"imgs/pants/womens-st-yellow-03.jpg",label:"Left Side"},{src:"imgs/pants/womens-st-yellow-04.jpg",label:"Right Side"},{src:"imgs/pants/womens-st-yellow-05.jpg",label:"45° Angle"},{src:"imgs/pants/womens-st-yellow-06.jpg",label:"Detail"},{src:"imgs/pants/womens-st-sizechart.png",label:"Size Chart"}], category: "women_st", collection: "Unisex Street Track Pants / Drop 001", tags: ["Track Pant", "Yellow", "Unisex"], availability: "Limited Drop", desc: "Gold-yellow wide-leg track pant with a relaxed street silhouette. Pairs with black and earth tones for a clean drop-001 finish." }
];
...
const CATEGORY_CONFIGS = {
  ...
  tops: {
    title: "Women Tops",
    label: "Festival · Chain · Mesh",
    nav: "Tops",
    href: "women-tops.html",
    description: "Silver mesh, rainbow chainmail, rhinestone chain — KRYPTAA tops built for festival nights and after-dark statements.",
    heroIds: [50, 52, 60, 61, 62],
    featuredIds: [50, 52, 60, 61]
  },
  women_track: {

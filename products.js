const RAW_PRODUCTS = [
  { id: 1, name: "Medusa Serpent Oversized Tee", price: 39, sizes: ["S", "M", "L", "XL", "2XL"], img: "imgs/tees/tee-1.png", gallery: [{src:"imgs/tees/tee-1.png",label:"Back"},{src:"imgs/tees/tee-1-g2.png",label:"Back (Male)"},{src:"imgs/tees/tee-1-g3.png",label:"Front"},{src:"imgs/tees/tee-1-g4.png",label:"Side"},{src:"imgs/tees/tee-1-g5.png",label:"Artwork"},{src:"imgs/tees/tee-1-g6.png",label:"Detail"},{src:"imgs/tees/tee-1-g7.png",label:"Close Up"}], category: "tees", collection: "Heavyweight / Drop 001", tags: ["Medusa", "Serpent", "Oversized"], availability: "Limited Drop", desc: "Black oversized heavyweight tee with Medusa serpent goddess back print and dark gothic throne graphic on the front. Dual-sided statement built for the underground." },

const RAW_PRODUCTS = [
  { id: 1, name: "Medusa Serpent Oversized Tee", price: 39, sizes: ["S", "M", "L", "XL", "2XL"], img: "imgs/tees/tee-1.png", hero: "imgs/tees/tee-1-homescreen.png", gallery: [{src:"imgs/tees/tee-1.png",label:"Back"},{src:"imgs/tees/tee-1-g2.png",label:"Back (Male)"},{src:"imgs/tees/tee-1-g3.png",label:"Front"},{src:"imgs/tees/tee-1-g4.png",label:"Side"},{src:"imgs/tees/tee-1-g5.png",label:"Artwork"},{src:"imgs/tees/tee-1-g6.png",label:"Detail"},{src:"imgs/tees/tee-1-g7.png",label:"Close Up"}], category: "tees", collection: "Heavyweight / Drop 001", tags: ["Medusa", "Serpent", "Oversized"], availability: "Limited Drop", desc: "Black oversized heavyweight tee with Medusa serpent goddess back print and dark gothic throne graphic on the front. Dual-sided statement built for the underground." },
  { id: 3, name: "Angel of Death Heavyweight Tee", price: 39, sizes: ["S", "M", "L", "XL", "2XL"], img: "imgs/tees/tee-2.png", gallery: [{src:"imgs/tees/tee-2.png",label:"Front"},{src:"imgs/tees/tee-2-g2.png",label:"View 2"},{src:"imgs/tees/tee-2-g3.png",label:"View 3"},{src:"imgs/tees/tee-2-g4.png",label:"View 4"},{src:"imgs/tees/tee-2-g5.png",label:"Artwork"},{src:"imgs/tees/tee-2-g6.png",label:"Detail"},{src:"imgs/tees/tee-2-g7.png",label:"Close Up"}], category: "tees", collection: "Heavyweight / Drop 001", tags: ["Angel", "Skeleton", "Metal Graphic"], availability: "Limited Drop", desc: "Black heavyweight tee with full-front Angel of Death graphic — winged skeleton rising over flame and skulls with blood-drip type. High-impact gothic metal energy." },
  { id: 4, name: "Broken Skull Heavyweight Tee", price: 39, sizes: ["S", "M", "L", "XL", "2XL"], img: "imgs/tees/tee-3.png", gallery: [{src:"imgs/tees/tee-3.png",label:"Graphic"},{src:"imgs/tees/tee-3-g2.png",label:"Artwork"},{src:"imgs/tees/tee-3-g3.png",label:"View 3"},{src:"imgs/tees/tee-3-g4.png",label:"View 4"},{src:"imgs/tees/tee-3-g5.png",label:"View 5"},{src:"imgs/tees/tee-3-g6.png",label:"Detail"},{src:"imgs/tees/tee-3-g7.png",label:"Close Up"}], category: "tees", collection: "Heavyweight / Drop 001", tags: ["Skull", "Fire", "Broken"], availability: "Limited Drop", desc: "Bold fire-and-skull heavyweight tee with 'BROKEN' blood-drip lettering and a cigar-smoking flaming skeleton. Uncompromising graphic energy on a premium black base." },
  { id: 5, name: "Need Some Money Oversized Tee", price: 39, sizes: ["S", "M", "L", "XL", "2XL"], img: "imgs/tees/tee-4.png", gallery: [{src:"imgs/tees/tee-4.png",label:"Back"},{src:"imgs/tees/tee-4-g2.png",label:"Artwork"},{src:"imgs/tees/tee-4-g3.png",label:"View 3"},{src:"imgs/tees/tee-4-g4.png",label:"View 4"},{src:"imgs/tees/tee-4-g5.png",label:"View 5"},{src:"imgs/tees/tee-4-g6.png",label:"Detail"},{src:"imgs/tees/tee-4-g7.png",label:"Close Up"}], category: "tees", collection: "Heavyweight / Drop 001", tags: ["Money", "Angel", "Gothic Type"], availability: "Limited Drop", desc: "Charcoal grey oversized tee with a full-front angel statue holding cash amid flames and chain-link. Old English 'need some MONEY' back text. The KRYPTAA hustle statement." },
...
window.STOCK_DATA = {
  ...
  10:  { "28": 30, "30": 30, "32": 30, "34": 30, "36": 30 }, // Men's — 30/size confirmed
  11:  { "28": 30, "30": 30, "32": 30, "34": 30, "36": 30 },
  12:  { "28": 30, "30": 30, "32": 30, "34": 30, "36": 30 },
  14:  { "28": 30, "30": 30, "32": 30, "34": 30, "36": 30 },
  30:  { XS: 30, S: 30, M: 30, L: 30 }, // Women's — 30/size confirmed
